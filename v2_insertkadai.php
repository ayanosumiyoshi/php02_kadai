...
$yamada_start = $_POST['yamada_start'];
$yamada_end = $_POST['yamada_end'];
$suzuki_start = $_POST['suzuki_start'];
$suzuki_end = $_POST['suzuki_end'];
$tanaka_start = $_POST['tanaka_start'];
$tanaka_end = $_POST['tanaka_end'];
...
$stmt = $pdo->prepare(
  ...
  VALUES(:name, :date, :starttime, sysdate(), :comment)"
);
